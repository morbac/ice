  ...
  tinymce.create('tinymce.plugins.IcePlugin', {
    ...
    init: function(ed, url) {
      ...
      ed.on('init', function(e) {
        ...
        // refrence css for editor content
        ...
        style.type = 'text/css';
        style.innerHTML = ".mce-i-accept { background-image: url("+url+"/img/accept.svg) !important; }" +
                          ".mce-i-reject { background-image: url("+url+"/img/reject.svg) !important; }";
