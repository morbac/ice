  ...
  tinymce.create('tinymce.plugins.IcePlugin', {
    ...
    init: function(ed, url) {
      ...
      ed.on('init', function(e) {
        ...
        var realUrl = url;
        if (self.pluginPath) {
          realUrl = this.documentBaseUrl + self.pluginPath;
        }
        ...
        dom.loadCSS(self.css.indexOf('://') > 0 ? self.css : (realUrl + '/' + self.css));
        ...
        style.type = 'text/css';
        style.innerHTML = ".mce-i-accept { background-image: url("+realUrl+"/img/accept.svg) !important; }" +
                          ".mce-i-reject { background-image: url("+realUrl+"/img/reject.svg) !important; }";
      ...
      ed.addButton('ice_toggleshowchanges', {
        ...
        image : url + '/img/ice-showchanges.svg',
        onclick: function () {
      ...
      ed.addButton('ice_togglechanges', {
        ...
        image : url + '/img/ice-togglechanges.svg',
